...
এটি একটি টার্মিনাল-ভিত্তিক স্ক্রিপ্ট যা টারমাক্স (Termux) বা লিনাক্স (Linux) এনভায়রনমেন্টে ব্যবহার করা যায়। নিচে প্রজেক্টটি সেটআপ এবং রান করার জন্য সঠিক কমান্ডগুলো দেওয়া হলো।
